...
const page = () => {
    ...
    useEffect(() => {
        document.title = "Login - Get Me A Drink"
        if (session) {
    ...
    return (
        <div className='text-white py-14 container mx-auto'>
            <h1 className='text-center font-bold text-5xl'>Login/Signup to get your fans to support you</h1>

            <div className="social-login-button flex flex-col  justify-center items-center h-[44vh] gap-3">
